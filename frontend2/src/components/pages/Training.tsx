...
const Training = () => {
  ...
  // Define isTraining before it's used in useEffect
  const isTraining = trainingStatus?.status === 'training' || trainingStatus?.status === 'loading_data';
  ...
  const trainingTimeSeconds = (trainingLogs as any)?.training_time as number | undefined;
